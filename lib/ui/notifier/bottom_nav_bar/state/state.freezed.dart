...
mixin _$BottomNavBarState {
  ...
  BottomNavBarItem get currentItem => throw _privateConstructorUsedError;
...
abstract class $BottomNavBarStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int currentIndex, BottomNavBarItem currentItem});
}
...
class _$_BottomNavBarState extends _BottomNavBarState {
  _$_BottomNavBarState(
      {this.currentIndex = 0, this.currentItem = BottomNavBarItem.home})
      : super._();
  ...
  @override
  @JsonKey()
  final BottomNavBarItem currentItem;

  @override
  String toString() {
    return 'BottomNavBarState(currentIndex: $currentIndex, currentItem: $currentItem)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, currentIndex, currentItem);
...
abstract class _BottomNavBarState extends BottomNavBarState {
  factory _BottomNavBarState(
      {final int currentIndex,
      final BottomNavBarItem currentItem}) = _$_BottomNavBarState;
  _BottomNavBarState._() : super._();

  @override
  int get currentIndex;
  @override
  BottomNavBarItem get currentItem;
  @override
  @JsonKey(ignore: true)
  _$$_BottomNavBarStateCopyWith<_$_BottomNavBarState> get copyWith =>
      throw _privateConstructorUsedError;
